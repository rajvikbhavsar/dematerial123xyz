...
<body class="bg agileinfo">
   <h1 class="agile_head text-center">Upload File </h1>
        ...
        <div id="parentHorizontalTab_agile">
            ...
            <div class="resp-tabs-container hor_1">
               <div class="w3_agile_login">
                    <form action="upload.php" method="post" class="agile_form" enctype="multipart/form-data">
					  <!-- <p>Facultyname</p>
					  ...
					  <p>Subject Name</p>
					  <input type="text" name="sname" required="required"  class="username1"> 
					  <p>File Name</p>
					  <input type="text" name="fname" required="required"  class="username1"> 
                      <p>Select a file to upload</p>
                      
                      
                      <input name="uploadedfile" type="file"  class="username1"/>
					  ...
					  <input type="submit" value="Upload" class="agileinfo" />
					</form>
               ...
               <!--  <div class="agile_its_registration">
                    <form   action ="main.php"method="post" class="agile_form" name="form1" onSubmit="return check();">
					  ...
					  <p>Phone No</p>
					  <input type="number" name="mobileno" required="required"><br>

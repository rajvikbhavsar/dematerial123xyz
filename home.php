...
$sql = "INSERT INTO user values('$user11','$name1','$branch1',$semester1,'$email1','$password11','$mobileno1')";
$con->query($sql);
...
<form action="flogin.php">
<input type="submit" value="Faculty"><br><br><br>
</form>
<form action="Registration.php">
<input type="submit" value="Student">
</form>

 <!--<input type="text" name=student login  />
 <p>Faculty login</p>
 <input type="text" name=faculty login  />
...
<!-- <p>username</p>
 ...
 <p>Password</p>
 <input type="password" name="password1" required="required" class="password1" />
 <div class="check">
...
<div class="login_w3ls">
 ...
 <p>Phone No</p>
 <input type="number" name="mobileno" required="required" class="username1"><br>

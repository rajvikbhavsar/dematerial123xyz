...
<head>
<title>E-Learning Study Material</title>
...
<div class="wrapper row1">
  <div id="header" class="clear">
    <div class="fl_left">
      <h1><a href="index.html">E-Learning Study Material</a></h1>
  ...
  <div id="topnav">
    <ul>
      ...
      <li><a href="#">Semester</a>
        <ul>
        	<li><a href="sem1.php">Sem 1</a></li>
          <li><a href="sem2.php">Sem 2</a></li>
          <li><a href="sem3.php">Sem 3</a></li>
          <li><a href="sem4.php">Sem 4</a></li>
          <li><a href="sem5.php">Sem 5</a></li>
          <li><a href="sem6.php">Sem 6</a></li>
          <li><a href="sem7.php">Sem 7</a></li>
          <li><a href="sem8.php">Sem 8</a></li>
          
        </ul>
      </li>
       <li><a href="http://gtu-info.com/GTU-Exam-Papers/Branch-Semester">GTU Papers</a></li>
       <li><a href="pages/style-demo.html">FeedBack</a></li>
...
<div class="wrapper row3">
  <div id="featured_slide"> 
    ...
    <ol>
       <li>
        <h2><span>Automobile engineering</span></h2>
        <div><img src="images/demo/featured-slide/ae.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Civil engineering</span></h2>
        <div><img src="images/demo/featured-slide/cv.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Computer engineering</span></h2>
        <div><img src="images/demo/featured-slide/ce.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Electrical engineering</span></h2>
        <div><img src="images/demo/featured-slide/ae.jpg" alt="" /></div>
      </li>
      <li>
        <h2><span>Electronics And Communication</span></h2>
        <div><img src="images/demo/featured-slide/it.jpg" alt="" /></div>
      </li>
      ...
      <li>
        <h2><span>Machenical engineering</span></h2>
        <div><img src="images/demo/featured-slide/me.jpg" alt="" /></div>
      </li>
...
<div class="wrapper row5">
  <div id="footer" class="clear"> 
    ...
    <div class="foot_contact">
      <h2>Saffrony Institute Of Technology</h2>
      <address>
      Near Shanku&#x2019s Water Park,<br> Ahmedabad &#x2010 Mehsana Highway, <br>Linch, Gujarat 384435
      </address>
      <ul>
        <li><strong>Tel:</strong> 070464 61000</li>
        <li><strong>Fax:</strong> xxxxx xxxxxxxxxx</li>
        <li class="last"><strong>Email:</strong> <a href="#">saffrony@gmail.com</a></li>
      </ul>
    </div>
   <!-- <div class="footbox">
